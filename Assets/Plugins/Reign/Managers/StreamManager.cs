...
namespace Reign
{
    ...
    public static class StreamManager
    {
		...
		/// <param name="fileTypes">File types the user can see in file popup.</param>
		/// <param name="streamLoadedCallback">The callback that fires when done.</param>
		public static void LoadFileDialog(FolderLocations folderLocation, string[] fileTypes, StreamLoadedCallbackMethod streamLoadedCallback, bool reset = false)
		{
            if (reset) loadingStream = false;//强制更新成已经回调过了
		...
		public static void LoadCameraPicker(CameraQuality quality, StreamLoadedCallbackMethod streamLoadedCallback,bool reset = false)
		{
            if (reset) loadingStream = false;//强制更新成已经回调过了
