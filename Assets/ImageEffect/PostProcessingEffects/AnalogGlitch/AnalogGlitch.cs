...
[Serializable]
[PostProcess(typeof(AnalogGlitchRenderer), PostProcessEvent.BeforeStack, "Custom/AnalogGlitch")]
...
public sealed class AnalogGlitchRenderer : PostProcessEffectRenderer<AnalogGlitch>
{
    ...
    {
        PropertySheet sheet = context.propertySheets.Get(Shader.Find("Custom/AnalogGlitch"));
