...
[Serializable]
[PostProcess(typeof(TonemapRenderer), PostProcessEvent.AfterStack, "Custom/Tonemap")]
...
public sealed class TonemapRenderer : PostProcessEffectRenderer<Tonemap>
{
    ...
    {
        PropertySheet sheet = context.propertySheets.Get(Shader.Find("Custom/Tonemap"));
