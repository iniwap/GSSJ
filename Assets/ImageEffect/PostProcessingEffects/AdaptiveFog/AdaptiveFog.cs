...
[Serializable]
[PostProcess(typeof(AdaptiveFogRenderer), PostProcessEvent.BeforeStack, "Custom/AdaptiveFog")]
...
public sealed class AdaptiveFogRenderer : PostProcessEffectRenderer<AdaptiveFog>
{
    ...
    {
        PropertySheet sheet = context.propertySheets.Get(Shader.Find("Custom/AdaptiveFog"));
