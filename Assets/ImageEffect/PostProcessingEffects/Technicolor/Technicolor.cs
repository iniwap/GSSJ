...
[Serializable]
[PostProcess(typeof(TechnicolorRenderer), PostProcessEvent.BeforeStack, "Custom/Technicolor")]
...
public sealed class TechnicolorRenderer : PostProcessEffectRenderer<Technicolor>
{
    ...
    {
        PropertySheet sheet = context.propertySheets.Get(Shader.Find("Custom/Technicolor"));
