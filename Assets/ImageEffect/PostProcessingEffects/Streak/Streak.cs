...
public sealed class Streak : PostProcessEffectSettings
{
    ...
    [Range(0, 1)] public FloatParameter stretch = new FloatParameter { value = 1f };
    [Range(0, 1)] public FloatParameter intensity = new FloatParameter { value = 0.5f };
    public float ColorValue { get; set; }
    [ColorUsage(false)] public ColorParameter tint = new ColorParameter { value = new Color(1f, 192/255f, 203/255f) };
}
...
public sealed class StreakRenderer : PostProcessEffectRenderer<Streak>
{
    ...
    public override void Render(PostProcessRenderContext context)
    {
        ...
        // Shader uniforms
        PropertySheet sheet = context.propertySheets.Get(Shader.Find("Custom/Streak"));
