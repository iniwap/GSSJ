...
{
    [Range(0.00001f, 0.1f), Tooltip("Gradient Threshold")]
    public FloatParameter gradThreshold = new FloatParameter { value = 0.01f };
    [Range(0f, 1f), Tooltip("Color Threshold")]
    public FloatParameter colorThreshold = new FloatParameter { value = 1.0f };
    [Range(0f, 100f)]
...
public sealed class PencilRenderer : PostProcessEffectRenderer<Pencil>
{
    ...
    {
        PropertySheet sheet = context.propertySheets.Get(Shader.Find("Custom/Pencil"));
